...
<form action="{{ route('theloai.update', ['id' => $cat->id]) }}" method="post">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.Hllo every body.</small>
        </div>
      <div class="form-group">
